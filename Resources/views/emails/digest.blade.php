                            ...
                            <tr>
                                <td class="content-cell">
                                    ...
                                    <table align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td align="center">
                                                <h1 style="margin: 0; color: black; font-family: 'Merriweather', serif; font-size: 50px;">Canvas</h1>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <p style="font-size: 24px;">
                                        {{ __('blog::mail.digest.summary') }} {{ $data['end_date'] }}
                                    </p>

                                    <p style="text-transform: uppercase; font-size: 12px; font-weight: lighter;">
                                        {{ __('blog::mail.digest.details') }}
                                    </p>

                                    <p style="font-weight: bolder; font-size: 20px;">
                                        {{ __('blog::mail.digest.from') }} {{ $data['start_date'] }} {{ __('blog::mail.digest.to') }} {{ $data['end_date'] }}, {{ __('blog::mail.digest.data') }}:
                                    </p>

                                    <h1>
                                        <span style="font-size: 32px;">{{ number_format($data['total_views']) }}</span>
                                        <br>
                                        <span style="font-size: 16px; color: #8e8e8e">{{ __('blog::mail.digest.views') }}</span>
                                    </h1>
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        ...
                                                                        <td class="panel-item" width="30%">
                                                                            <span style="font-size: 16px; color: #8e8e8e; font-weight: bolder;">{{ __('blog::mail.digest.views_this_week') }}</span>
                                                                            <br>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td>
                                                                        <a href="{{ route('blog.admin.index') }}" class="button button-primary" target="_blank">
                                                                            {{ __('blog::buttons.stats.index') }}
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="content-cell" align="center">
                                    <span style="font-size: 12px;">
                                        {{ __('blog::mail.general.sent_by') }} <a href="http://cnvs.io" class="text-muted" target="_blank">Canvas</a>
                                    </span>
                                </td>
                            </tr>
                        </table>
