...
@section('context', $data['post']->published ? __('blog::nav.context.published') : __('blog::nav.context.draft'))
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            @if($data['post']->published)
                <a href="{{ route('blog.admin.stats.show', $data['post']->id) }}" class="dropdown-item">
                    {{ __('blog::nav.controls.stats') }}
                </a>
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                @include('blog::components.forms.post.edit')
                @include('blog::components.modals.post.delete')
            </div>
        </div>
    </div>
@endsection
