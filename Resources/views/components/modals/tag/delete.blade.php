    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <p class="font-weight-bold lead">{{ __('blog::tags.delete.header') }}</p>

                {{ __('blog::tags.delete.warning') }}
            </div>
            <div class="modal-footer">
                ...
                <form id="form-delete" action="{{ route('blog.admin.tag.destroy', $tag->id) }}" method="POST" style="display: none">
